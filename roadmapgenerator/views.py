...
def roadmap_generator_view(request):
    try:
        ...
        roadmap = graph.invoke(State(user_id=user.id, current_role=current_role, target_role=target_role, job_description=job_description, duration=10, hours_per_day=8, user_query=user_query))
